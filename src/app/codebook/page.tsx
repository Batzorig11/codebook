...
const LABELS = {
  mn: {
    ...
    badge: "Кодын лавлах",
    subtitle: "Команд бүрийн бичиглэл, тайлбар, жишээг нэг дороос харах.",
    commandN: (n: number) => `Команд ${n}`,
    explanation: "Тайлбар",
    example: "Жишээ",
    imgAlt: (name: string) => `${name} командын зурагт тайлбар`,
  },
  en: {
    backHome: "Back to Home",
    badge: "Command Reference",
    subtitle: "View the syntax, explanation, and example for each command.",
    commandN: (n: number) => `Command ${n}`,
    explanation: "Explanation",
    example: "Example",
    imgAlt: (name: string) => `${name} command illustration`,
  },
} as const;
...
const codebookData: {
  ...
  },
  {
    ...
    syntax: "player.push()",
    explanation: {
      mn: "Энэ функц нь тоглогчийг харж буй чиглэл рүү объект түлхэхэд ашиглагдана, хэрэв замд саад байхгүй бол.\nExample:\n\nЭнэ код нь тоглогчийг зүүн тийш эргүүлээд тухайн чиглэлд объект түлхэнэ.",
      en: "This function is used to have player push an object in the direction he is facing provided there is not a collision blocking object's trajectory. Example:\n\nThis code will have player turn left and push a movable object in the direction he is facing.",
    },
    example: "player.turn_left()\nplayer.push()",
  ...
  },
  {
    ...
    explanation: {
      mn: "Энэ функц нь тоглогчийг өгөгдсөн текстийг хэлэхэд ашиглагдана. Тоглоом дээр энэ нь тоглогчийн толгойн дээр текст гарч ирэх байдлаар харагдана.\nExample:\n\nЭнэ код нь \"Hello World\" гэсэн үгийг тоглогчийн толгойн дээр харуулна.",
      en: "This function is used to have player call out a string that is specified in this function's argument. In game this is expressed by the string being drawn on screen over the player's head. Example:\n\nThis code will have the phrase \"Hello World\" displayed over the player's head.",
    },
  ...
  },
  {
    ...
    syntax: "player.water()",
    explanation: {
      mn: "Энэ функц нь тоглоом дахь объектуудыг услахад ашиглагдана, жишээ нь ургамал услах эсвэл ус дүүргэхэд.\n\nExample:\n\nЭнэ код нь тоглогчийн харж буй чиглэлд байгаа объектыг усална.",
      en: "The function can be used to water objects in game, such as watering crops and refilling water trays. In game this is usually used for farming and homesteading.\n\nExample:\n\nUsing this code the player can water an object in the direction they are facing.",
    },
  ...
  },
  {
    ...
    explanation: {
      mn: "Энэ функц нь нөөц цуглуулахад ашиглагдана. Ихэвчлэн дуусдаг зүйлсийг дахин дүүргэхэд хэрэглэгддэг (жишээ нь ус авах).\n\nExample:\n\nЭнэ код нь тоглогчийг ус цуглуулаад дараа нь зүүн тийш эргэж объект услах боломжтой болгоно.",
      en: "This function is used to collect resources that you can't claim as part of your inventory. This is usually used to replenish inventory items that can be exhausted, for example filling a canteen with water. Example:\n\nThis code will have the player collect water from a water source they are facing, then turn left to water an object.",
    },
  ...
  },
  {
    ...
    explanation: {
      mn: "Энэ функц нь хаалга болон сав нээхэд ашиглагдана. Ингэснээр нэвтрэх эсвэл доторх зүйлийг авах боломжтой болно.\n\nExample:\n\nЭнэ код нь тоглогчийг зүүн тийш эргүүлээд хаалга нээгээд цааш нэвтрэх боломжтой болгоно.",
      en: "This function is used to open doors and containers, this can be useful for crossing entryways or opening containers to pick up or place objects. Example:\n\nThis code will have player turn left to open a door and then cross through it.",
    },
    example: "player.turn_left()\nplayer.open()\nplayer.move_forward()",
  ...
  },
  {
    ...
    syntax: "player.close()",
    explanation: {
      mn: "Энэ функц нь хаалга болон сав хаахад ашиглагдана. Жишээ нь хаалгаа хаах эсвэл савыг буцааж хаахад хэрэглэнэ.\n\nExample:\n\nЭнэ код нь тоглогчийг сав нээгээд, доторх зүйлийг аваад дараа нь буцааж хаана.",
      en: "This function is used to close doors and containers, this can be useful for closing doors behind you or closing a container after you've placed something inside.\n\nExample:\n\nThis code will have player open a container, collect an item from it, and then close the container.",
    },
    example: 'player.open()\nplayer.collect("item")\nplayer.close()',
  ...
  },
  {
    ...
    explanation: {
      mn: "Энэ функц нь объект, зүйл эсвэл хувьсагчийг зөвшөөрөгдсөн байрлалд байрлуулахад ашиглагдана. Ихэвчлэн саванд хийх эсвэл тодорхой газар тавихад хэрэглэнэ.\n\nExample:\n\nЭнэ код нь wheat нэртэй хувьсагчид тоо хадгалаад түүнийг байрлуулна.",
      en: "This function is used to place an object, item or variable in a location where objects are allowed to be placed. This is usually used to store items in a container or setting down objects in specified locations. Example:\n\nThis code illustrates player storing a number inside a variable named wheat and then the place() function being used to place the variable in a designated location.",
    },
    example: "wheat = 6\nplayer.place(wheat)",
  ...
  },
  {
    ...
    explanation: {
      mn: "Энэ функц нь хэд хэдэн объектыг нэгтгэж шинэ объект үүсгэхэд ашиглагдана. Ихэвчлэн хоол, ундаа эсвэл бодис хийхэд хэрэглэгддэг.\n\nExample:\n\nЭнэ код нь \"jar\" жагсаалтад байгаа бүх зүйлийг нэгтгэж шинэ зүйл үүсгэнэ.",
      en: "This function is used to have player combine different objects together to produce a brand new object. This is usually used to combine ingredients to make food, drink or substances. Example:\n\nThis code will have player take everything in a list named \"jar\" and combine them to form a new item/object.",
    },
  ...
  },
  {
    ...
    explanation: {
      mn: "Энэ функц нь газар тариа тарихад ашиглагдана. Dictionary ашигладаг бөгөөд 2 параметр авна: dictionary-ийн нэр болон key.\n\nExample:\n\nДоорх код нь тоглогчийг хашны үр тарьж дараа нь услахад ашиглагдана.",
      en: "This function is used to plant objects in the ground, this is usually reserved for planting crops. This function uses dictionaries, it takes 2 arguments, the name of the dictionary and the dictionary key. Example:\n\nIn the below code the player plants eggplant seeds in the soil and then waters them.",
    },
  ...
  },
  {
    ...
    explanation: {
      mn: "Энэ функц нь popup мессеж харуулна. Энэ нь async функц бөгөөд level-д урьдчилан бэлтгэсэн мессежийг харуулна. Мессеж хаагдах хүртэл програм түр зогсоно.\n\nExample:\n\nЭнэ код нь popup мессеж харуулж, тоглогч хаах хүртэл програмыг зогсооно.",
      en: "Allow a message to be displayed, this is an async function that allows a pop up to show a message that has been pre-recorded in the level. Program is paused until the message is closed. Example:\n\nIn the above code a popup message is displayed with a pre-recorded message manually embedded into the level, pausing the program until the player closes the message.",
    },
  ...
  },
  {
    ...
    explanation: {
      mn: "Энэ функц нь объект, сав эсвэл мэдээлэл уншихад ашиглагдана. Ихэвчлэн савны доторх агуулгыг шалгах эсвэл мессеж уншихад хэрэглэгддэг.\n\nExample:\n\nЭнэ код нь box нэртэй савны доторхыг уншина.",
      en: "This function is used to have player read an object, item or variable. This is usually used to read the contents of a container or to read a message. Example:\n\nThis code will have player read the contents of a container named box.",
    },
  ...
  },
  {
    ...
    explanation: {
      mn: "Энэ функц нь yes/no асуулт бүхий popup харуулна. Энэ нь async функц бөгөөд хэрэглэгчийн сонголтоос хамаарч Boolean утга буцаана.\n\nExample:\n\nЭнэ код нь асуулт харуулж, хэрэглэгчийн хариунаас хамаарч дараагийн үйлдлийг шийднэ.",
      en: "Allow a message to be displayed with a yes or no question, this is an async function that allows a pop up to show a message provided and produces a Boolean variable based on input. Example:\n\nIn the above code a popup message is displayed with a question with yes and no buttons, pausing the program until the player makes a selection.",
    },
  ...
  },
  {
    ...
    explanation: {
      mn: "Энэ функц нь тоглогчид мессеж харуулахад ашиглагдана.\n\nExample:\n\nЭнэ код нь тоглогчид мессеж харуулна.",
      en: "This function is used to display a message to the player. Example:\n\nThis code will display a message to the player.",
    },
          ...
          {codebookData.map((item, index) => (
            ...
            >
              ...
              <div>
                ...
                <Explanation>{item.explanation[lang]}</Explanation>
              </div>
