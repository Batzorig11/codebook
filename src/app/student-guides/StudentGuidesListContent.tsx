...
import type { StudentGuide } from "@/lib/student-guides";
...
const LABELS = {
  mn: {
    ...
    badge: "Сурагчийн материал",
    title: "Гарын авлага",
    subtitle: "Бүлэг бүрийн Markdown гарын авлагыг эндээс нээж уншина.",
    read: "Унших",
  },
  en: {
    backHome: "Back to Home",
    badge: "Student Materials",
    title: "Study Guides",
    subtitle: "Open and read the Markdown guide for each chapter here.",
    read: "Read",
  },
} as const;
